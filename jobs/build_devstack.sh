...
run_ssh_cmd_with_retry ubuntu@$DEVSTACK_IP $DEVSTACK_SSH_KEY "zuul-cloner -m /home/ubuntu/clonemap.yaml -v git://git.openstack.org $ZUUL_PROJECT --zuul-branch $ZUUL_BRANCH --zuul-ref $ZUUL_REF --zuul-url $ZUUL_SITE/p --workspace /opt/stack"
